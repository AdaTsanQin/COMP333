...
const ViewRequestsScreen = () => {
  ...
  const fetchRequests = async () => {
    try {
      const response = await fetch("http://129.133.75.138/WesDashAPI/accept_requests.php", {
        method: "GET",
        credentials: "include",
  ...
  const handleDeleteRequest = async (id) => {
    try {
      const response = await fetch("http://172.21.94.10/WesDashAPI/accept_requests.php", {
        method: "DELETE",
