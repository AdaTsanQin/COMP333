<?php
// File: /Applications/XAMPP/xamppfiles/htdocs/WesDashAPI/create_tip.php
...
// 2) Load secrets.php (with your $stripeSecretKey)
...
$stmt = $conn->prepare("SELECT est_price FROM requests WHERE id=?");
...
// 5) Build correct domain + path
//    Note the “/WesDashAPI” here so tip_success.php is found
...
$session = \Stripe\Checkout\Session::create([
    ...
    'line_items' => [[
      'price_data' => [
        ...
        'product_data'=> ['name'=>"{$percent}% Tip for Order #{$requestId}"],
      ],
      'quantity'=>1,
    ]],
    'mode'        => 'payment',
